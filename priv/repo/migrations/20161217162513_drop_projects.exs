...
defmodule CaosTsdb.Repo.Migrations.DropProjects do
  defmodule MigrationModels do
    ...
    def models do
      ...
      quote do
        ...
        alias unquote(module).SeriesOld
  ...
  defmodule MigrationModels.SeriesOld do
    use Ecto.Schema
    use MigrationModels, :models
    ...
    schema "series" do
      ...
      many_to_many :tags, Tag, join_through: SeriesTag,
        join_keys: [series_id: :id, tag_id: :id]
  ...
  def up do
    ...
    execute "ALTER TABLE series DROP FOREIGN KEY series_project_id_fkey"

    # Drop composite primary key
    execute "ALTER TABLE series DROP PRIMARY KEY, ADD PRIMARY KEY (id)"

    # Drop composite index
    drop index(:series, [:project_id, :metric_name, :period])
